...
# docker pull registry.cn-hangzhou.aliyuncs.com/google-containers/flannel:v0.11.0-amd64
# docker tag registry.cn-hangzhou.aliyuncs.com/google-containers/flannel:v0.11.0-amd64 quay.io/coreos/flannel:v0.11.0-amd64
